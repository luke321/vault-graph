#!/usr/bin/env node
// Build a DEMO vault that is structurally your vault and contains none of your content.
//
//   node scripts/make-demo-vault.mjs                       # from $OBSIDIAN_VAULT
//   node scripts/make-demo-vault.mjs --vault D:/Notes --out demo-vault --seed 7
//
