...
- **A settings tab for the plugin, and a gear for the standalone page.** Each lists every
  ...
  [`0008-the-host-persists-settings-not-the-page`](.ai-context/decisions/0008-the-host-persists-settings-not-the-page.md).
...
The invariant suite passes 17/17 against both vaults, unchanged.
